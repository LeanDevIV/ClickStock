...
const ProductDetail = () => {
  ...
  const mainImage = product.imagenes?.[selectedImage] || "https://via.placeholder.com/600x400?text=Sin+imagen";
                  ...
                  {product.imagenes.map((img, index) => (
                    <Box
                      ...
                      sx={{
                        ...
                        height: 60,
                        borderRadius: 1,
                        border: selectedImage === index ? `2px solid ${theme.palette.primary.main}` : '1px solid',
